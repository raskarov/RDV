...
{
    /// <summary>
    /// Форма выбора улиц в выпадающем списке
    /// </summary>
    public class ObjectFormStreetField: ObjectFormField
    {
        /// <summary>
        ...
        protected override void ApplyDefaultAttributes(TagBuilder builder)
        {
            ...
            builder.AddCssClass("street-field");
        }
        ...
        public override string RenderFieldEditor(FieldRenderingContext context)
        {
            ...
            builder.Attributes.Add("value", IdObjectsCache.GetStreetName(Value.ConvertToNullableLong()));
            ...
            hiddenBuilder.Attributes.Add("id", "street-id-field");
        ...
        {
            return IdObjectsCache.GetStreetName(Value.ConvertToNullableLong());
        }
    }
}