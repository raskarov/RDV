...
using RDV.Web.Classes.ElFinderConnector.Response;
using RDV.Web.Classes.ElFinderConnector.Response.Open;

namespace RDV.Web.Classes.ElFinderConnector.Facade
{
    /// <summary>
